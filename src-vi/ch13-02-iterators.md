...
3-5 ở Chương 3, chúng ta đã lặp qua một mảng bằng vòng lặp `for` để thực thi một
...
Chú ý rằng định nghĩa này sử dụng một số cú pháp mới: `type Item` và
...
`collect`, mà chúng ta đã sử dụng trong Chương 12 với `env::args` trong Listing
