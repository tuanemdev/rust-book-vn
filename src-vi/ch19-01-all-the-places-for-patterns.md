...
<Listing number="19-2" caption="Sử dụng vòng lặp `while let` để in giá trị miễn là `rx.recv()` trả về `Ok`">
...
<Listing number="19-3" caption="Sử dụng mẫu trong vòng lặp `for` để phân rã một tuple">
...
Trong các câu lệnh như `let x = 5;` với tên biến trong vị trí _`PATTERN`_, tên
...
<Listing number="19-4" caption="Sử dụng mẫu để phân rã một tuple và tạo ba biến cùng một lúc">
...
19-5 cho thấy một nỗ lực phân rã một tuple với ba phần tử thành hai biến, điều
...
<Listing number="19-6" caption="Một chữ ký hàm sử dụng mẫu trong các tham số">
...
<Listing number="19-7" file-name="src/main.rs" caption="Một hàm với các tham số phân rã một tuple">
