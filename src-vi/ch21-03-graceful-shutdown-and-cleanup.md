...
pháp thay thế. Chúng có thể làm cho mã của bạn sạch hơn và ít dễ xảy ra lỗi hơn.
...
`Vec`, và trả về một iterator của các mục đó. Truyền cú pháp phạm vi `..` sẽ xóa
_mọi_ giá trị khỏi `Vec`.
